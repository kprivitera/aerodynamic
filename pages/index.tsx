      ...
      <div className={styles.pageWrapper}>
        ...
        <div className={styles.homeContainer}>
          ...
          <div className={styles.servicesContainer}>
            ...
            <Service title="Flight data monitoring" description="Flight Data Monitoring (FDM) programmes assist an operator to identify, quantify, assess and address operational risks. Safety Regulation Groups have helped develop and support such systems and used FDM information to support a range of airworthiness and operational safety tasks.  Many operators have demonstrated the safety benefits of FDM such that the International Civil Aviation Organization (ICAO) have made a standard for all Air Transport operations in aircraft over 27 tonnes with effect 1st January 2005 to operate an FDM system. Initially a FDM system will be used as part of an operator’s System Safety Assessment to identify deviations from SOPs or areas of risk and measure current safety margins. This will establish a baseline operational measure against which to detect and measure any change. Aerodynamics provides a hosted FDM service which allows 24hr access to the software when required from anywhere. Remote access allows the user to perform the same tasks as an in-house system without the hassle of maintaining the appropriate licences and updates. We have an experienced team of Flight Data analysts on hand that maintain your system and perform the day to day FDM administration processes. This allows users to focus on their roles and increase productivity. Our team are also available to provide support\training and any requests and technical issues over a 24hr period."/>
